"""
Damascus Emergency Inventory — License Key Generator (windows)  v4.0.1-P
=====================================================================
  Generates activation licenses for the Damascus Emergency Inventory
  PROTECTED desktop application (v4.0.1, Ed25519-signed).
  Usage: python KeyGenerator-v4.0.1-P-windows.py
...
def print_header():
    w = 67
    print("=" * w)
    print("  Damascus Emergency Inventory  —  License Key Generator  v4.0.1-P  (windows)")
