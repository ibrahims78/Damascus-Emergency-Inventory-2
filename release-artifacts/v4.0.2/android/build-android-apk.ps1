...
$env:RELEASE_KEYSTORE_PATH = Join-Path $root 'release-artifacts\v4.0.2\release-secrets\android\android-release.keystore'
# STEP (one time): generate the keystore on the build machine with keytool:
#   keytool -genkeypair -v -keystore release-artifacts/v4.0.2/release-secrets/android/android-release.keystore -alias dme -keyalg RSA -keysize 2048 -validity 10000
