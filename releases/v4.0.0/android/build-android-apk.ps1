...
#   powershell -ExecutionPolicy Bypass -File releases/v4.0.0/android/build-android-apk.ps1
...
$env:RELEASE_KEYSTORE_PATH = Join-Path $root 'releases\v4.0.0\release-secrets\android\android-release.keystore'
# STEP (one time): generate the keystore on the build machine with keytool:
#   keytool -genkeypair -v -keystore releases/v4.0.0/release-secrets/android/android-release.keystore -alias dme -keyalg RSA -keysize 2048 -validity 10000
