...
LOG_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "issued-licenses-v4.0.3-android.log")
...
def print_header():
    w = 67
    print("=" * w)
    print("  Damascus Health Directorate  -  License Key Generator  v4.0.3-P  (android)")
...
def main():
    ...
    if _SEED is None:
        ...
        print("      Run this generator from release-secrets/android, or place the key")
