...
const files = {
  ...
  "02-export-baseline.xlsx": workbook([
    ["PH0-EXPORT-001", "شاش معقم - عينة", "مستلزمات إسعافية", "علبة", 12, 3, "2027-01-31", "FIX-B-001", "مورد اختباري", "رف A-01", "بيانات اصطناعية"],
  ]),
  "03-new-item.xlsx": workbook([
    ["PH0-NEW-001", "قفازات فحص - عينة", "مستلزمات إسعافية", "علبة", 0, 2, "", "", "", "رف A-02", "مادة اختبارية جديدة"],
  ]),
  "04-batch-input.xlsx": workbook([
    ["PH0-BATCH-001", "محلول ملحي - عينة", "مستلزمات إسعافية", "زجاجة", 25, 5, "2027-06-30", "FIX-B-002", "مورد اختباري", "رف B-01", "دفعة اختبارية"],
  ]),
  "05-intentional-errors.xlsx": workbook([
    ["PH0-ERR-001", "", "مستلزمات إسعافية", "علبة", 1, 0, "", "", "", "", "اسم مفقود"],
    ["PH0-ERR-002", "كمية سالبة - عينة", "مستلزمات إسعافية", "علبة", -2, 0, "", "", "", "", "كمية سالبة"],
